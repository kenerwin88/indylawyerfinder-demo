...
return _CF_checkregex(_40,/^[a-zA-Z_0-9-'\&\+~]+(\.[a-zA-Z_0-9-'\&\+~]+)*@([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,63}$/,_41);
};
...
return _CF_checkregex(_42.toLowerCase(),/^((http|https|ftp|file)\:\/\/([a-zA-Z0-0]*:[a-zA-Z0-0]*(@))?[a-zA-Z0-9-\.]+(\.[a-zA-Z]{2,3})?(:[a-zA-Z0-9]*)?\/?([a-zA-Z0-9-\._\?\,\'\/\+&amp;%\$#\=~])*)|((mailto)\:[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*@([a-zA-Z0-9-]+\.)+[a-zA-Z0-9]{2,63})|((news)\:[a-zA-Z0-9\.]*)$/,_43);
};
